    ...
    <div className="d-flex m-0 p-0 justify-content-center align-items-center">
      <span className="form-check m-0 p-0">
        ...
        <label
          ...
          htmlFor="approved_checkbox_student"
        >
          Approved
        </label>
      </span>
      <span className="form-check m-0 p-0 me-3 ms-3">
        ...
        <label
          ...
          htmlFor="pending_checkbox_student"
        >
          Pending
        </label>
      </span>
      <span className="form-check m-0 p-0">
        <input
          type="checkbox"
          className="btn-check"
          id="disapproved_checkbox_student"
          autoComplete="off"
          defaultChecked=""
        ...
        <label
          ...
          htmlFor="disapproved_checkbox_student"
        >
          Disapproved
        </label>
      </span>
