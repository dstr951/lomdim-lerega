    ...
    return (
        <div className="d-flex m-0 p-0 justify-content-center align-items-center">
          <span className="form-check m-0 p-0">
            <input type="checkbox" className="btn-check" id="approved_checkbox" autoComplete="off"
          ...
          <span className="form-check m-0 p-0 me-3 ms-3">
            <input type="checkbox" className="btn-check" id="pending_checkbox" autoComplete="off"
          ...
          <span className="form-check m-0 p-0">
            <input type="checkbox" className="btn-check" id="disapproved_checkbox" autoComplete="off"
