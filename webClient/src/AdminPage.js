    ...
    <div className="container h-100">
      <div className="row h-100 d-flex p-0 m-0 justify-content-center">
        ...
        <Checkbox
          ...
          setApprovedChecked={setApprovedChecked}
          pendingChecked={pendingChecked}
          setPendingChecked={setPendingChecked}
          disapprovedChecked={disapprovedChecked}
          setDisapprovedChecked={setDisapprovedChecked}
        />
        {profiles ? (
          <ProfilesList
            approvedChecked={approvedChecked}
