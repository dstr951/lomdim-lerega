...
//לשים לב בריטרנ שיש לנו את הערך מוכנס להדר
    return (
                            ...
                            <div className="right-section">
                                <Image 
                                    ...
                                    <div className='text-box'>
                                        <h2 id="orange-text">{teacherData.firstName} {teacherData.lastName}</h2>
                                        <p>
